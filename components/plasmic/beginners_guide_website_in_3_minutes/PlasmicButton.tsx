...
import sty from "./PlasmicButton.module.css"; // plasmic-import: o3RCiIr-AAAG/css

import CircleIcon from "./icons/PlasmicIcon__Circle"; // plasmic-import: cAwmqPtRgCwq/icon
import ChevronDown2Icon from "./icons/PlasmicIcon__ChevronDown2"; // plasmic-import: XOnrYWcPVOkp/icon
  ...
  return (
    ...
    >
      ...
      <Stack__
        as={"div"}
        hasGap={true}
        className={classNames(projectcss.all, sty.freeBox__hlWJs, {
          [sty.freeBoxcolor_neutral__hlWJsqu7HZ]: hasVariant(
            $state,
            "color",
            "neutral"
          ),
          [sty.freeBoxcolor_success_type_bordered__hlWJs0Hg9DEjhYf]:
            hasVariant($state, "color", "success") &&
            hasVariant($state, "type", "bordered"),
          [sty.freeBoxcolor_white__hlWJs8HSoM]: hasVariant(
            $state,
            "color",
            "white"
          ),
          [sty.freeBoxroundedFull__hlWJsEhB2D]: hasVariant(
            $state,
            "roundedFull",
            "roundedFull"
          ),
          [sty.freeBoxsize_extraLarge__hlWJsCaFq8]: hasVariant(
            $state,
            "size",
            "extraLarge"
          ),
          [sty.freeBoxsize_extraSmall__hlWJs9Ohkz]: hasVariant(
            $state,
            "size",
            "extraSmall"
          ),
          [sty.freeBoxsize_large__hlWJsyGj9X]: hasVariant(
            $state,
            "size",
            "large"
          ),
          [sty.freeBoxsize_small__hlWJsVvnq]: hasVariant(
            $state,
            "size",
            "small"
          ),
          [sty.freeBoxtype_bordered__hlWJsEjhYf]: hasVariant(
            $state,
            "type",
            "bordered"
          )
      ...
      >
        <div
          className={classNames(projectcss.all, sty.freeBox__sz1Ri, {
            [sty.freeBoxcolor_neutral__sz1Riqu7HZ]: hasVariant(
              $state,
              "color",
              "neutral"
            ),
            [sty.freeBoxiconStart__sz1RiKfWsc]: hasVariant(
              $state,
              "iconStart",
              "iconStart"
            ),
            [sty.freeBoxsize_extraLarge__sz1RiCaFq8]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__sz1RiyGj9X]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__sz1RiVvnq]: hasVariant(
              $state,
              "size",
              "small"
            ),
            [sty.freeBoxtype_bordered__sz1RiEjhYf]: hasVariant(
              $state,
              "type",
              "bordered"
            ),
            [sty.freeBoxtype_soft_color_neutral__sz1Ri7E3JbQu7HZ]:
              hasVariant($state, "color", "neutral") &&
              hasVariant($state, "type", "soft")
          })}
        >
          {renderPlasmicSlot({
            defaultContents: (
              <CircleIcon
                className={classNames(projectcss.all, sty.svg__vcFzl)}
                role={"img"}
              />
            ),
        ...
        <div
          className={classNames(projectcss.all, sty.freeBox__rMsaD, {
            [sty.freeBoxiconEnd__rMsaDgknHp]: hasVariant(
              $state,
              "iconEnd",
              "iconEnd"
            ),
            [sty.freeBoxsize_extraLarge__rMsaDcaFq8]: hasVariant(
              $state,
              "size",
              "extraLarge"
            ),
            [sty.freeBoxsize_large__rMsaDyGj9X]: hasVariant(
              $state,
              "size",
              "large"
            ),
            [sty.freeBoxsize_small__rMsaDvvnq]: hasVariant(
              $state,
              "size",
              "small"
            )
        ...
        >
          {renderPlasmicSlot({
            defaultContents: (
              <ChevronDown2Icon
                className={classNames(projectcss.all, sty.svg__rGf8K)}
                role={"img"}
              />
            ),
